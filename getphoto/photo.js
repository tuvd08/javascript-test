...
var FS = {
  ...
  getPicasa: function (size) {
    ...
    if (FS.local.indexOf("google") > 0) {
      var cont = document.getElementById('renderData');
      if (cont == null) {
  ...
  block: function (info) {
    ...
    if (!div) {
      var style = "background: #ffffff; padding: 10px";
 ...
 displayBlock: function (elm, id) {
  ...
  button: function () {
    ...
    if (!div) {
      ...
      div.id = 'button';
      div.setAttribute("style", "position: absolute; z-index:290000; overflow:auto; top: 50px; right: 30px; border: 3px double gray; background: #ffffff; padding: 5px");
