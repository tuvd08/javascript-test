...
$.smoothScroll = function(options, px) {
  ...
  if(opts.offsetFunction && $.isFunction(opts.offsetFunction)) {
    offset = opts.offsetFunction();
  }
  aniProps[scrollDir] = scrollTargetOffset + scrollerOffset + offset;
  ...
  if ($scroller.length) {
    ...
    if(isIpad) {
      $("#IpadBarHolder").animate({'top': aniProps[scrollDir]}, speed, opts.easing, function() {});
    }
  } else {
    opts.afterScroll.call(opts.link, opts);
  }
