		...
		for (var dayOfWeek=0; dayOfWeek < 7; dayOfWeek++) {
		  var currentWeekDay = (dayOfWeek + this.fistWeekDay) % 7;
			...
			if (validDay) {
				...
				table = table + "<td><a class='"+clazz+"' href=\"javascript:module.DateTimePicker.setDate("+this.currentDate.getFullYear()+","+(this.currentDate.getMonth() + 1)+","+dayOfMonth+")\">"+dayOfMonth+"</a></td>" ;
				dayOfMonth++ ;
			} else {
