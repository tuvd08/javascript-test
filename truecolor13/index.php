...
<? if ($info->handle){?>
     ...
     <th>
      ...
      <tr>
           <td align="center"><A href="#" onclick="objresize.showIt();return false;">Resize - Scale</a></td>
      </tr>
      <tr>
           <td align="center"><A href="#" onclick="objrotate.showIt();return false;">Rotate - Mirror</a></td>
      </tr>
      <tr>
           <td align="center"><A href="#" onclick="showCorners(true);objclip.showIt();return false;">Cropping</a></td>
      </tr>
      <tr>
...
<table cellspacing="2" cellpadding="2" class="white">
   ...
   <th>
     <A href="#" onclick="showCorners(false);objclip.hideIt();return false;">CLOSE</a>
   </th>

   <tr>
    <td>Left</td><td><input name="offset_left" type="text" value="0" size="2"> px</td>
    <td>Top</td><td><input name="offset_top" type="text" value="0" size="2"> px</td>
    <td><input type="hidden" name="tocrop"></td>
   </tr>
   <tr>
     <td>Right</td><td><input name="offset_right" type="text" value="<?=$info->width?>" size="2"> px</td>
     <td>Bottom</td><td><input name="offset_bottom" type="text" value="<?=$info->height?>" size="2"> px</td>
     <td><input type="submit" value=" APPLY "></td>
   </tr>
...
<div id="imgdiv">
<? if ($info->handle){ ?>
<IMG src="<?=$info->directory.$info->filename?>" <?=$info->string; ?> align="absmiddle">
<? } ?>
</div>
